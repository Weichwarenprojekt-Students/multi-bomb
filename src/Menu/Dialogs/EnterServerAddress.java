...
public class EnterServerAddress extends JPanel {
    public EnterServerAddress(ServerView serverView) {
        setLayout(null);
        setBackground(Color.white);
        setBounds(0, 0, 3 * MARGIN + 2 * BUTTON_WIDTH, 100 + BUTTON_HEIGHT + MARGIN);

        //The title
        MBLabel title = new MBLabel(MBLabel.H2, "Enter Server Address");
        ...
        confirm.addActionListener(e -> {
            serverView.addRemoteServer(input.getText());
